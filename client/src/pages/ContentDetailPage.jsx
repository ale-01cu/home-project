...
export const ContentDetail = () => {
  ...
  return (
    <div className={`flex flex-col gap-y-5 lg:flex-row pb-5 lg:px-18 xl:px-24 ${!content.seasons.length > 0 ? 'justify-center items-center' : ''}`}>
              ...
              <div className="flex flex-wrap gap-1">
                {content.genders.map(gender => (
                  <GendersList 
                    key={gender.id} 
                    gender={gender} 
                    className={"rounded-lg align-middle text-sm font-medium py-1 px-2 "} />
                ))}
              </div>
            </div>  
