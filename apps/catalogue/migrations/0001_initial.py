    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('path', models.CharField(max_length=255, verbose_name='Ruta en disco duro')),
                ('format', models.CharField(blank=True, max_length=50, verbose_name='Formato')),
                ('size', models.CharField(blank=True, max_length=10, verbose_name='Tamaño')),
                ('release_year', models.IntegerField(validators=[django.core.validators.MaxValueValidator(2100), django.core.validators.MinValueValidator(1900)])),
                ('subtitles', models.BooleanField(default=False, verbose_name='Esta Subtitulada')),
                ('spanish', models.BooleanField(default=False, verbose_name='Esta en Español')),
                ...
                ('photo', models.ImageField(upload_to=apps.catalogue.helpers.generate_content_photo_path, verbose_name='Foto de Portada')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number_of_chapters', models.PositiveIntegerField(verbose_name='Cantidad de Capitulos')),
                ('serie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='seasons', to='catalogue.content', verbose_name='Temporadas')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(unique=True, upload_to=apps.catalogue.helpers.generate_content_photo_path, verbose_name='Url de la Imagen')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images', to='catalogue.content', verbose_name='Prodduto')),
            ],
            options={
                'verbose_name': 'Imagen',
