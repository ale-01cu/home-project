...
export class Folmulario {
    ...
    construirFormPelicula() {
        this.inputFileSerie.previousElementSibling.classList.contains("hidden") 
            ? ""
            : this.inputFileSerie.previousElementSibling.classList.add("hidden")

        this.containerTemporadas.classList.contains("hidden") 
            ? ""
            : this.containerTemporadas.classList.add("hidden")
    ...
    construirFormSerie() {
        this.inputFile.previousElementSibling.classList.contains("hidden") 
            ? ""
            : this.inputFile.previousElementSibling.classList.add("hidden")
    ...
    btnSubir () {
        ...
        addEventListener("scroll", e => {
            ( scrollY === 0 ) ? btn.classList.add("hidden") : btn.classList.remove("hidden")
        })
    }
